...
- Work_Schedule/ — project planning and schedule documents (milestones, timelines, Gantt charts, weekly plans). Add spreadsheets, PDFs, or text files describing the work plan.
- presentation_sujet/ — presentation materials and subject description (slides, PDF handouts, speaker notes, images, and related assets).
